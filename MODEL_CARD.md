...
See the paper (Tables 2–4) for full comparison results against state-of-the-art methods, and Tables 5–6 for ablation studies. Qualitative visual comparisons between D3F-Det and the baseline YOLOv12-s on real UAV-captured images from all three datasets are available in the \texttt{img\_results/} directory of the repository.
